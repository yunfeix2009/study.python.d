...
def register_commands(app):
    ...
    @app.cli.command()
    @click.option('--repeat_times', default=5, help='Quantity of repeat_times, default is 5')
    def test(repeat_times):
        # from bluelog.fakes import
        for message in range(repeat_times):
            click.echo('test'+' message:'+str(message)+' repeate_times'+str(repeat_times))
        click.echo('Done.')
